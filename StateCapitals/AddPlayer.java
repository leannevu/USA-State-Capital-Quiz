 ...
 *<pre>
 Class          AddPlayer
 File           AddPlayer.java
 Description    A class used to add new player
...
public class AddPlayer extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        answersJLabel = new javax.swing.JLabel();
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CapitalImages/Topeka.jpg"))); // NOI18N
        ...
        answersJLabel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        answersJLabel.setText("Correct Answers:");
        inputJPanel.add(answersJLabel);

        answersJTextField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                answersJTextFieldFocusLost(evt);
            }
        });
        inputJPanel.add(answersJTextField);
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    private void saveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJButtonActionPerformed
         ...
         String playerCorrectAnswers = answersJTextField.getText();
         ...
         if (!Validation.isValidName(playerName)){
             errorMessage += "Invalid Player Name \n";
              ...
              error = true;
              answersJTextField.setToolTipText ("--Invalid Age") ;
         }else if (!Validation.isInteger(playerCorrectAnswers, 0, 100)){
              errorMessage += "Invalid input\n";
              ageJTextField.requestFocus();
              error = true;
              ageJTextField.setToolTipText("--Invalid Balance") ;
         } else if (!Validation.isInteger(playerCorrectAnswers, 0, 100)){
              errorMessage += "Invalid input\n";
              ageJTextField.requestFocus();
              error = true;
         ...
         if (!error)  // all input valid
         {
             try{
                ...
                correctAnswers = Integer.parseInt( answersJTextField.getText());
    ...
    *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
     ...
     * Description   Event handler for the answersJTextFieldFocusLost().
     *               It changes colors if input is not a valid name.
     * @parem        evt FocusEvent
     * @author       <i>Leanne Vu</i>	
     * Date          4/24/2021
     *</pre>
     * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    private void answersJTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_answersJTextFieldFocusLost
                // Set background textfield color
        String input = answersJTextField.getText();
        if (Validation.isInteger(input, 0 , 100))
            answersJTextField.setBackground(white);
        else
            answersJTextField.setBackground(pink);
    }//GEN-LAST:event_answersJTextFieldFocusLost

    /**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     *<pre>
     * Method        balanceJTextFieldFocusLost() 
     * Description   Event handler for the numOfQuestionsJTextFIeldFocusLost().
     *               It changes colors if input is not a valid name.
     * @parem        evt FocusEvent
     * @author       <i>Leanne Vu</i>	
     * Date          4/24/2021
   ...
   /**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    private javax.swing.JLabel answersJLabel;
